...
- 在本题中，BFS的解法比DP快，核心在于，此题中步长是固定的！DP在很多无效的位置做了无用功。



## Extension I: find minimum number of word break from dictionary.
- BFS, record level, and return when first find the string with target.
- DP, dp table record the minimum operation to reach till this position i. 

## Extension II: print our all the possible combination.
